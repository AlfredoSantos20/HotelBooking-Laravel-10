$(document).ready(function(){
    ...
    $(document).ready(function() {
        // // Set initial values and trigger change events
        // const initialRegionId = "{{ $Employee->region_id }}";
        // const initialProvinceId = "{{ $Employee->province_id }}";
        // const initialCityId = "{{ $Employee->city_id }}";
        // const initialBarangayId = "{{ $Employee->barangay_id }}";
